...
# More details in GitHub repository: https://github.com/Raschka-research-group/hotspotter
...
if __name__ == "__main__":
    ...
    parser.add_argument("--trained_model", help="Path to the trained model",
                        type=str, default="./mlp.joblib")

    parser.add_argument("--trained_model_sequence_only",
                        help="Path to the trained model for --sequence_only prediction.",
                        type=str, default="./mlp_sequence_only.joblib")

    parser.add_argument('--sequence_only',
                        type=str,
                        choices=("true", "false"),
                        default="false")

    parser.add_argument('--print_row_numbers',
                        type=str,
                        choices=("true", "false"),
                        default="false")
